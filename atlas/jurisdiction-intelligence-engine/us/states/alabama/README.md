...
Alabama is a jurisdiction package within the Satoshium Atlas jurisdiction intelligence framework.
...
The canonical package records Alabama as a Southeast interior support continuity jurisdiction organized around inland Southeast continuity, Gulf-facing continuity, and Southeast support-position adjacency inside the broader southeastern corridor frame. The evidence layer is retained from corridor continuity between adjacent Atlas states — Tennessee, Georgia, Mississippi, and Florida — rather than from independent state-sourced research. The signals layer reflects three structural coordination signals: inland Southeast continuity, Gulf-facing continuity, and Southeast support-position adjacency, with no independent establishment of freight, rail, energy-grid, BEAD coordination, or inland-waterway continuity beyond the retained corridor anchors.
