...
Satoshium Attestor is released under the MIT License.
...
* Use Attestor for personal projects.
* Use Attestor within organizations.
* Modify Attestor.
* Extend Attestor.
* Incorporate Attestor into other software.
...
Consistent with the MIT License, Attestor is provided:
